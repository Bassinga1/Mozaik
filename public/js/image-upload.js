    ...
    input.addEventListener('change', (e)=>{
        ...
        if(file){
            ...
            reader.onload = function(){
                ...
                if(imgParent.querySelector('.img-form-services')){
                    imgParent.querySelector('a').setAttribute("href", reader.result);
                    // imgParent.querySelector('a').setAttribute("data-lightbox", "image");
                    imgParent.querySelector('.img-form-services').setAttribute("src", reader.result);
                }else{
                    ...
                    img.classList.add('img-fluid', 'img-form-services');
